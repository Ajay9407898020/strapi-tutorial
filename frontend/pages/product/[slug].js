                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex">
                            ...
                            <div className='flex mx-2'>
                                <button onClick={()=>{addToCart(slug,1, product.attributes.price)}} className="flex ml-auto mx-2 text-white bg-indigo-500 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded">Add to cart</button>
                                <button onClick={()=> {router.push('/checkout')}} className="flex ml-auto mx-2 text-white bg-indigo-500 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded">checkout</button>
                            </div>
